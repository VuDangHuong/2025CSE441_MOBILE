package com.example.firebasedemo.ui.auth
...
import com.example.firebasedemo.data.model.Staff
import com.example.firebasedemo.data.model.Student
import com.example.firebasedemo.data.model.TLUUnit
import com.example.firebasedemo.data.model.UserType
import com.example.firebasedemo.databinding.ActivityProfileBinding
import com.example.firebasedemo.utils.DataProvider
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun loadProfileImage(url: String) {
        if (url.isNotEmpty()) {
            Glide.with(this)
                .load(url)
                .placeholder(com.example.firebasedemo.R.drawable.ic_person)
                .error(com.example.firebasedemo.R.drawable.ic_person)
